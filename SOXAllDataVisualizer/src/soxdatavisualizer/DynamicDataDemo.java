...
public class DynamicDataDemo extends ApplicationFrame implements ActionListener {
    ...
    public DynamicDataDemo(final String title) {
        ...
        super(title);
        this.series = new TimeSeries("Num of data", Millisecond.class);
    ...
    public void plus(){
    	...
    	numOfData++;
        this.series.addOrUpdate(new Millisecond(), numOfData);
    ...
    public static void main(final String[] args) {
        ...
        final DynamicDataDemo demo = new DynamicDataDemo("Num of data received ");
        demo.pack();
